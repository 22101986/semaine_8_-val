...
function addLayer() {
  ...
  function makeCloseButton() {
    ...
    closeButton.innerText = "Lancer la partie";
  ...
  function makeWarning(text) {
    ...
    title.innerText = "The South-Park Memory Game!!!";
    ...
    httpRequest.onreadystatechange = function() {
      if (httpRequest.readyState === XMLHttpRequest.DONE) {
        if (httpRequest.status === 200) {
          ...
          addMessageBox("Bienvenue dans le Colorado pour une partie de mémory pas comme les autres!!! Serez-vous à la hauteur???");
        }
      }
    };
